...
test: 
	clang -fsanitize=leak -I ./mlx_linux/ so_long.c config_map.c gnl/*.c libft/ft_calloc.c  libft/ft_bzero.c libft/ft_split.c -L ./mlx_linux/ -lmlx -Ilmlx -lXext -lX11 ./mlx_linux/libmlx.a
